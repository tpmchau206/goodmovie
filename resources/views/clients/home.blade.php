...
<div class="video d-flex justify-content-center">
    ...
    <div><img class="poster" src="{{ asset('asset/clients/images/'.$moviesTrailer->poster) }}" alt=""></div>
        <script>
    ...
    <div class="container1 d-flex">
        <div class="left d-flex flex-column justify-content-end ">
            ...
            <div class="button-content d-flex align-items-center">
                ...
                <a class="popup-click-main button-info d-flex align-items-center" data-custom-attribute="{{$moviesTrailer->id}}">
...
<div class="movies-series">
    <div class="movies-list">
        <h2 class="title-content">
            <a href="#" class="skeleton">Top 10 Movie hay tại Việt Nam</a>
        </h2>
        <div class="top-movie">
            @php
                $i=0;
            ...
            <div class="top-rank skeleton">
                {{-- <form action="{{ url('popups')}}" method="post"> --}}
                    <a href="{{ route('popup',$dataRankMovie['view'][$i]->id)}}" type="btn" class="popup-click" data-custom-attribute="{{$dataRankMovie['view'][$i]->id}}" >
                        <div class="boxart-size">
                            {!! $dataRankMovie['top'][$i] !!}
                            <img src="{{ asset('asset/clients/images/'.$dataRankMovie['view'][$i]->image) }}" alt="">
                        </div>
                    </a>
                {{-- </form> --}}
            </div>
    ...
    <div class="movies-list">
        ...
        <div class="top-movie">
            ...
            <div class="movie skeleton">
                <a href="{{ route('popup',$popular->id)}}" type="btn" class="popup-click" data-custom-attribute="{{$popular->id}}" data-toggle="collapse" data-target="#demo">
                    <div class="boxart-size">
                        <img class="card-img-top" src="{{asset('asset/clients/images/'.$popular->poster)}}" alt="">
                    </div>
                </a>
            </div>
            @endforeach
    ...
    <div class="movies-list ">
        ...
        <div class="top-movie">
            @foreach ($popularMovie as $popular)
            <div class="movie skeleton">
                <a a href="{{ route('popup',$popular->id)}}" type="btn" class="popup-click" data-custom-attribute="{{$popular->id}}" data-toggle="collapse" data-target="#demo">
